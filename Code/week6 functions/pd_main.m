clear all;
clc;
useSDR = true; % You can skip this section if unchecked
if useSDR
...
if useSDR % Capture live CSI with SDR
    ...
    [dataNoPresence,labelNoPresence,timestampNoPresence] = loadCSIDataset("Collect_DataNoPresence.mat","no-presence");
