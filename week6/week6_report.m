...
if useSDR % Capture CSI with SDR
    ...
    [dataNoPresence,labelNoPresence,timestampNoPresence] = loadCSIDataset("NP000.mat","no-presence");
end
%%
if useSDR % Capture live CSI with SDR
    [dataPresence,labelPresence,timestampPresence] = captureCSIDataset(rxsim,"presence");
else % No SDR hardware, load CSI dataset
    [dataPresence,labelPresence,timestampPresence] = loadCSIDataset("YP000.mat","presence");
end
%%
trainingRatio =  0.8;
numEpochs = 10;
